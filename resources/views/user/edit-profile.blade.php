...
@section('content')
    ...
    <div class="d-flex justify-content-center">
        <form method="POST" action="{{ url('/auth/update-profile') }}" enctype="multipart/form-data" class="w-100"
            style="max-width: 400px;">
            @csrf

            <!-- Profile Image -->
            <div class="text-center mb-3">
                <div class="rounded-circle bg-secondary d-flex justify-content-center align-items-center mx-auto mb-2"
                    style="width: 100px; height: 100px;">
                    <img id="profilePreview" src="{{ auth()->user()->image }}" alt="Profile Picture"
                        style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                </div>
                <label for="profileImage" class="btn btn-outline-warning btn-sm">
                    <i class="bi bi-upload"></i> Add
                </label>
                <input type="file" name="image" id="profileImage" class="d-none" accept="image/*"
            ...
            <div class="text-end mb-3">
                <a href="{{ url('auth/change-pass') }}" class="text-decoration-none text-white-50 small">Change password</a>
            </div>
            <!-- Save Button -->
            <button type="submit" class="btn w-100 mt-2 my-4"
