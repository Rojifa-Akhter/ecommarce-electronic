...
<p class="text-muted mb-4">You can edit your profile picture & personal information</p>

<div class="d-flex justify-content-center">
    <form method="POST" action="{{ url('/user/update-profile') }}" enctype="multipart/form-data" class="w-100" style="max-width: 400px;">
        @csrf
        ...
        <div class="text-center mb-3">
            <div class="rounded-circle bg-secondary d-flex justify-content-center align-items-center mx-auto mb-2" style="width: 100px; height: 100px;">
                <img id="profilePreview" src="{{ asset('images/user-placeholder.png') }}" alt="Profile Picture" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
            </div>
